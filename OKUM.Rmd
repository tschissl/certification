...
measur <- 'P2O5' # defining the measurand
``` 
...
outlier <- c(31, 33 ) ## defining the outlying lab here with lab#
...
#### comments
lab #33 based on Youden plot and lab plots, labs #31 based on Mandel k  
lab #6 is a border line problem
