...
```
The `r measurand` mean of the Lab means is `r round(mean, 4)` g/100 g  
The `r measurand` median of the Lab medians is `r round(median, 4)` g/100 g  
...
median <- median(tapply(GOM[[measurand]], GOM$Lab, median, na.rm=TRUE), na.rm=TRUE)
```
The `r measurand` mean of the Lab means after outlier removal is `r round(mean, 4)` g/100 g  
The `r measurand` median of the Lab medians after outlier removal is `r round(median, 4)` g/100 g 
